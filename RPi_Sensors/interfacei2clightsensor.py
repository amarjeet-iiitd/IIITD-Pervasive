#!/usr/bin/env python DIBAKAR BARUA- Interfacing I2C based light sensor
...
#first find out bus location and device address using i2cdetect -y 0 or 1
#initliaze bus access
bus = smbus.SMBus(1)
...
#dev address (as determined by i2cdetect
address = 0b00101001
...
def APDS_read():	
	...
	time.sleep(0.002) #delay to accomodate ACK bit
	i2cwrite(addrread)
	...
	Lux = lux_calc(CH1,CH0) #calculate luminositys
	return Lux
