...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'DBGUI_datarequest', (
            ...
            ('room', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['DBGUI.Room'])),
            ('request_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 15, 0, 0))),
    ...
    models = {
        ...
        u'DBGUI.datarequest': {
            ...
            'request_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 15, 0, 0)'}),
